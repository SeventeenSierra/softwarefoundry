...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: zEVuJ6opywlr/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: va530-gXfJd_/icon
    ...
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_accentCoolLow]: hasVariant(
            $state,
            "color",
            "accentCoolLow"
          ),
          [sty.rootcolor_accentCool]: hasVariant($state, "color", "accentCool"),
          [sty.rootcolor_accentWarmHigh]: hasVariant(
            $state,
            "color",
            "accentWarmHigh"
          ),
          [sty.rootcolor_accentWarmLow]: hasVariant(
            $state,
            "color",
            "accentWarmLow"
          ),
          [sty.rootcolor_accentWarm]: hasVariant($state, "color", "accentWarm"),
    ...
    >
      <div
        ...
        className={classNames(projectcss.all, sty.startIconContainer, {
          ...
          [sty.startIconContainercolor_error]: hasVariant(
            $state,
            "color",
            "error"
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__haJLv)}
              role={"img"}
            />
          ),
          ...
          className: classNames(sty.slotTargetStartIcon, {
            [sty.slotTargetStartIconcolor_error]: hasVariant(
              $state,
              "color",
              "error"
            ),
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.input, {
          ...
          [sty.inputcolor_error]: hasVariant($state, "color", "error"),
          [sty.inputcolor_infoLow]: hasVariant($state, "color", "infoLow"),
          [sty.inputcolor_secondaryLow]: hasVariant(
            $state,
            "color",
            "secondaryLow"
          ),
          [sty.inputcolor_success]: hasVariant($state, "color", "success"),
          [sty.inputcolor_warning]: hasVariant($state, "color", "warning"),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.endIconContainer, {
          [sty.endIconContainercolor_error]: hasVariant(
            $state,
            "color",
            "error"
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__qA91)}
              role={"img"}
            />
          ),
          ...
          className: classNames(sty.slotTargetEndIcon, {
            [sty.slotTargetEndIconcolor_error]: hasVariant(
              $state,
              "color",
              "error"
            ),
