...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: aZiADhfS3E6a/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: xkQQWycy2V6D/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__r59Ox)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___1Lrgt)}
              />
            </React.Fragment>
          ),
          value: args.children
