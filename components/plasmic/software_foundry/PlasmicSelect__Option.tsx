...
import sty from "./PlasmicSelect__Option.module.css"; // plasmic-import: 8HxlY0U-7Am0/css
...
const PlasmicDescendants = {
  root: ["root", "labelContainer", "freeBox"],
  labelContainer: ["labelContainer", "freeBox"],
  freeBox: ["freeBox"]
} as const;
