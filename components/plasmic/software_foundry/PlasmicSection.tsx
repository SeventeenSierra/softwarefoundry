...
import sty from "./PlasmicSection.module.css"; // plasmic-import: FQZn3RdELGBX/css
  ...
  return (
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <div className={classNames(projectcss.all, sty.freeBox__hBdo6)} />
          ),
