...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: G4aXVijMkSGJ/css

import SquaresvgIcon from "./icons/PlasmicIcon__Squaresvg"; // plasmic-import: cuS9wyG_dcQZ/icon
import SquareCheckFilledsvgIcon from "./icons/PlasmicIcon__SquareCheckFilledsvg"; // plasmic-import: TTG9Cs4eDL-M/icon
import SquareMinussvgIcon from "./icons/PlasmicIcon__SquareMinussvg"; // plasmic-import: 4nw5EhNwkYw9/icon
